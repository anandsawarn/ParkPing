  ...
  return (
    <section className="mx-auto max-w-lg">
      <div className="card fade-up">
        <h2 className="font-display text-2xl sm:text-3xl">Welcome back</h2>
        <p className="mt-2 text-sm text-ink/70 dark:text-white/70">Log in to manage your cars and QR codes.</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="text-right">
            <Link className="text-xs text-moss hover:underline" to="/forgot-password">
              Forgot password?
            </Link>
          </div>
